    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conPasswordIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (conPasswordShowing) {
                    ...
                    conPasswordIcon.setImageResource(R.drawable.eyeslash);
                }
                else {
                    conPasswordShowing = true;

                    conPassword.setInputType(InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                    conPasswordIcon.setImageResource(R.drawable.eye);
                }
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RegisterActivity.this, Validation.class);
